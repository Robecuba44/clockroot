    ...
    if (
      ...
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificBirdsong.Automated Alliance.Revolt`, {
            suit,
          }),
        ),
      );
      ...
      base.push(
        this.createMetaData(
          ...
          '',
          translate.instant(
            `SpecificBirdsong.Automated Alliance.RevoltSpread`,
            { sympathySpread },
          ),
        ),
      );
      ...
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificBirdsong.Automated Alliance.Spread`, {
            sympathySpread,
          }),
        ),
      );
  ...
  public daylight(translate: TranslateService) {
    ...
    const base = [
      this.createMetaData(
        'score',
        5,
        translate.instant(`SpecificDaylight.Automated Alliance.Sympathy`, {
          suit,
        }),
      ),
    ];
    ...
    if (suit === 'bird') {
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificDaylight.Automated Alliance.Revolt`),
        ),
      );
    }
  ...
  public evening(translate: TranslateService) {
    ...
    const base = [
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificEvening.Automated Alliance.Organize`, {
          organizeVal,
        }),
      ),
      this.createMetaData(
    ...
    if (this.hasTrait('Wildfire')) {
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificEvening.Automated Alliance.Wildfire`),
      );
    }
    ...
    if (this.difficulty === 'Nightmare') {
      base.push(
        this.createMetaData(
          ...
          1,
          translate.instant(
            `SpecificEvening.Automated Alliance.NightmareScore`,
          ),
        ),
      );
    }
