...
export class WoodlandBotDC extends Bot {
  ...
  public birdsong(translate: TranslateService) {
    const base = [
      this.createMetaData(
        ...
        '',
        translate.instant(
          `SpecificBirdsong.Automated Alliance (DC).RevealOrder`,
        ),
      ),
      this.createMetaData(
        'score',
        1,
        translate.instant(
          `SpecificBirdsong.Automated Alliance (DC).CraftOrder`,
        ),
      ),
    ];
    ...
    if (
      ...
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificBirdsong.Automated Alliance (DC).Revolt`, {
            suit,
          }),
        ),
      );
  ...
  public daylight(translate: TranslateService) {
    ...
    if (suit === 'bird') {
      base.push(
        this.createMetaData(
          ...
          5,
          translate.instant(
            `SpecificDaylight.Automated Alliance (DC).SympathyBird`,
            { suit },
          ),
        ),
      );
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificDaylight.Automated Alliance (DC).Revolt`),
        ),
      );
    } else {
      base.push(
        this.createMetaData(
          ...
          5,
          translate.instant(
            `SpecificDaylight.Automated Alliance (DC).Sympathy`,
            { suit },
          ),
        ),
      );
    ...
    const sympathySpread = this.customData.sympathy.slice(0, 5).every((x) => x)
      ? '1x'
      : '2x';
    base.push(
      this.createMetaData(
        ...
        '',
        translate.instant(
          `SpecificDaylight.Automated Alliance (DC).RevoltSpread`,
          { sympathySpread },
        ),
      ),
    );
  ...
  public evening(translate: TranslateService) {
    ...
    const base = [
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificEvening.Automated Alliance (DC).Organize`, {
          organizeVal,
        }),
      ),
      this.createMetaData(
        ...
        '',
        translate.instant(
          `SpecificEvening.Automated Alliance (DC).WarriorPlace`,
        ),
      ),
      this.createMetaData(
        'text',
    ...
    if (this.hasTrait('Wildfire')) {
      base.push(
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificEvening.Automated Alliance (DC).Wildfire`),
        ),
      );
    }
    ...
    if (this.difficulty === 'Nightmare') {
      base.push(
        this.createMetaData(
          ...
          1,
          translate.instant(
            `SpecificEvening.Automated Alliance (DC).NightmareScore`,
          ),
        ),
      );
    }
