  ...
  public birdsong(translate: TranslateService) {
    return [
      this.createMetaData(
        ...
        '',
        translate.instant(
          `SpecificBirdsong.Mechanical Marquise (DC).RevealOrder`,
        ),
      ),
      this.createMetaData(
        'score',
        1,
        translate.instant(
          `SpecificBirdsong.Mechanical Marquise (DC).CraftOrder`,
        ),
      ),
    ];
  }
  ...
  public daylight(translate: TranslateService) {
    ...
    if (this.customData.currentSuit === 'bird') {
      const base2 = [
        ...
        this.createMetaData(
          'text',
          '',
          translate.instant(`SpecificDaylight.Mechanical Marquise (DC).Bird1`, {
            totalWarriors,
          }),
        ),
        this.createMetaData(
    ...
    const base = [
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificDaylight.Mechanical Marquise (DC).Suit0`, {
          suit,
        }),
      ),
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificDaylight.Mechanical Marquise (DC).Suit1`, {
          totalWarriors,
          suit,
        }),
      ),
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificDaylight.Mechanical Marquise (DC).Suit2`, {
          building,
        }),
      ),
      this.createMetaData(
        'text',
        '',
        translate.instant(`SpecificDaylight.Mechanical Marquise (DC).Suit3`, {
          suit,
        }),
      ),
    ];
  ...
  public evening(translate: TranslateService) {
    ...
    const iwText = this.hasTrait('Iron Will')
      ? this.createMetaData(
          ...
          '',
          translate.instant(
            `SpecificEvening.Mechanical Marquise (DC).RepeatIronWill`,
          ),
        )
      : this.createMetaData(
          'text',
    ...
    if (this.customData.currentSuit === 'bird') {
      ...
      const base2 = [
        ...
        this.createMetaData(
          'score',
          maxScore,
          translate.instant('SpecificEvening.Mechanical Marquise (DC).Score', {
            score: maxScore,
          }),
        ),
        this.createMetaData(
      ...
      if (this.difficulty === 'Nightmare') {
        base2.push(
          this.createMetaData(
            ...
            1,
            translate.instant(
              'SpecificEvening.Mechanical Marquise (DC).NightmareScore',
            ),
          ),
        );
      }
